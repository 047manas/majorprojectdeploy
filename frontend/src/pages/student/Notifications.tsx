                ...
                <div className="space-y-3">
                    {notifications.map((n, index) => {
                        ...
                        return (
                            <Card
                                key={n.id}
                                className={`transition-all duration-300 ${!n.is_read ? 'border-l-4 border-l-indigo-500 bg-indigo-50/20 dark:bg-indigo-900/5' : ''} ${isClickable ? 'cursor-pointer hover:shadow-md hover:border-indigo-300 dark:hover:border-indigo-700 hover:-translate-y-0.5' : ''}`}
